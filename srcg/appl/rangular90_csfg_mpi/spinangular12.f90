!***********************************************************************
!                                                                      *
      SUBROUTINE SPINANGULAR12 (JASAV, JBSAV, IUNITF, NPOS)
!                                                                      *
...
!   CSFs generated by the JA-th CSFG.        
      ...
      IF (JB /= JA) THEN
        ...
        !write(*,*)"SA12 One-body: JA,JB,IA,IB =", JA,JB,IA,IB 
        ...
        IF (IA /= 0 .AND. IA /= IB .AND.       &
           ...
           ENDIF
!
! The following data should be used in calculations of elements between 
! JB-th CSF and the N CSFs generated by JA-th CSFG.
!           
           !NPOS = NPOS + 1
           !LINCR = .FALSE.
           !LLISTT = LLISTT + 1
