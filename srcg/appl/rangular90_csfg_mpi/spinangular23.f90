!***********************************************************************
!                                                                      *
      SUBROUTINE SPINANGULAR23 (JASAV, JBSAV, IUNITF, NPOS)
!                                                                      *
...
! FLAGU: < [Core B] K | [core A] I J> /= 0 with K = J,
             ! The following loops could be improved.
             DO K = 1, NORBROW
               N = 0
               DO I = 1, NORBCOLL
                 DO J = 1, NORBCOLU
                   N = N + 1
                   IF ((FLAGL .AND. K == I) .OR. (FLAGU .AND. K == J)) &
                     LNonZero(K,N) = .TRUE.
                 ENDDO
               ENDDO
             ENDDO
               ...
               DO K = 1, NORBROW
                 ...
                 DO I = 1, NORBCOLL
                   DO J = 1, NORBCOLU
                     ...
                     IF (FLAGU .AND. K == J) LNonZero(M,N) = .TRUE.
                   ENDDO
                 ENDDO
               ENDDO
             ENDIF
