!***********************************************************************
!                                                                      *
      SUBROUTINE SPINANGULAR45 (JASAV, JBSAV, IUNITF, NPOS)
!                                                                      *
...
!
      ...
      IF (NORBCOL > 1) THEN 
        FLAGU = .TRUE.
        ! < IR [CoreA] 7s^2 | ==> < IR [CoreA] 5s^2|
        CALL FICTIOUS_CSF(5, ICFICT+1, JA, NTYPE(3,JA)+1, NTYPE(4,JA), 0, 0)
      ENDIF
!
           ...
           IF (.NOT. LOSCAL) THEN
             ...
             DO K = 1, NORBROW - 1
               DO L = K + 1, NORBROW
                 ...
                 DO I = 1, NORBCOL
                   N = I
                   IF (MTYPE == 1 .AND. K == I) LNonZero(M,N) = .TRUE.
