...
!
      ...
      WRITE (ISTDE, *) 'There are ', NBLOCK, ' blocks  ', &
         '(block   J/Parity   NCFRSym   NCFTr):'
      WRITE (ISTDE, '( 4(I3, 1X, A5, I8, I8, 5X) )')      &
         (J, IDBLK(J)(1:5), NCFBLK(J), NCFBLKTr(J), J=1,NBLOCK)
  ...
  123 CONTINUE
      DO JBLOCK = 1, NBLOCK
         NCF = NCFBLK(JBLOCK)
  234    CONTINUE
         WRITE (ISTDE, *) 'Block ', JBLOCK, '   ncfsym = ', NCF, &
          '    ncfTr =', NCFBLKTr(JBLOCK),  ' id = ', IDBLK(JBLOCK)(1:5)
