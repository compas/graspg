...
!-----------------------------------------------
      ...
      logical, dimension(25,0:10,0:1) :: med
      character :: rad0*2000, rad1*2000, rad2*2000
         ...
         do k = 1, 220
            ...
            if (med(i,j,0)) then
               ...
               elseif(i<20 .and. i>=10) then
                  ...
                  rad0(pos:pos) = char(i + ichar('0') - 20)
                  rad0(pos-1:pos-1) = '2'
               endif
...
!PJ         write(9,999) rad1(1:stopp)
         do i = 1,2000
           ...
           if (rad1(i:i).eq.'@') rad1(i-1:i) = '16'
           if (rad1(i:i).eq.'A') rad1(i-1:i) = '17'
           if (rad1(i:i).eq.'B') rad1(i-1:i) = '18'
           if (rad1(i:i).eq.'C') rad1(i-1:i) = '19'
           if (rad1(i:i).eq.'D') rad1(i-1:i) = '20'
           if (rad1(i:i).eq.'E') rad1(i-1:i) = '21'
           if (rad1(i:i).eq.'F') rad1(i-1:i) = '22'
           if (rad1(i:i).eq.'G') rad1(i-1:i) = '23'
           if (rad1(i:i).eq.'H') rad1(i-1:i) = '24'
           if (rad1(i:i).eq.'I') rad1(i-1:i) = '25'
         end do
