...
!-----------------------------------------------
      ...
      integer  :: org(25,0:10)
      integer , intent(inout) :: low(25,0:10)
      integer  :: lim(25)
      logical , intent(inout) :: lock(25,0:10)
      logical , intent(inout) :: closed(25,0:10)
      logical , intent(out) :: dubbel(25,0:10)
!-----------------------------------------------
...
!-----------------------------------------------
!
      data (l(i),i=0,20)/ 'S', 'P', 'D', 'F', 'G', 'H', 'I', 'K', &
                          'L', 'M', 'N', 'O', 'Q', 'R', 'T', 'U', &
                          'V', 'W', 'X', 'Y', 'Z'/
      data (orb(i),i=0,10)/ 's', 'p', 'd', 'f', 'g', 'h', 'i', 'k',&
                            'l', 'm', 'n'/
   ...
   40 continue
      ...
      skal = 20
   60 continue
      write (*, 200) 'Highest n-number? (1..25)'
      read (193, *, err=60) nmax
      nmax = max(nmax,1)
      nmax = min(nmax,25) ! CYC
