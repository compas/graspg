...
!...Generated by Pacific-Sierra Research 77to90  4.3E  14:44:54  12/27/06
      ...
      logical, DIMENSION(25,0:10), INTENT(INOUT) :: LOCK
      logical, DIMENSION(25,0:10), INTENT(INOUT) :: CLOSED
      integer, INTENT(IN) :: VARMAX
      integer, INTENT(OUT) :: SKAL
      logical, INTENT(INOUT) :: SECOND
      integer, INTENT(IN) :: ANEL0
      integer, INTENT(OUT) :: PAR0
      integer, DIMENSION(25,0:10), INTENT(INOUT) :: LOW
      integer, INTENT(OUT) :: NMAX
      integer, DIMENSION(25), INTENT(INOUT) :: LIM
      logical, DIMENSION(25,0:10), INTENT(OUT) :: DUBBEL
