...
!-----------------------------------------------
      integer , intent(inout) :: posn(220)
      integer , intent(inout) :: posl(220)
!-----------------------------------------------
...
!-----------------------------------------------
      integer , dimension(25,0:10) :: stat
      integer :: i, n, l, num
      logical :: ok
...
!-----------------------------------------------
   ...
   20       continue
            ...
            if (l==(-1) .or. n<0 .or. n>25 .or. n<=l .or. l>10) go to 40
            if (stat(n,l) /= 0) then
