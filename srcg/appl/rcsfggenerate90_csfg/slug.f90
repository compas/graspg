...
!-----------------------------------------------
      ...
      integer , intent(inout) :: varupp(25,0:10)
      integer , intent(inout) :: varned(25,0:10)
      integer , intent(in) :: ansats(25,0:10,0:1)
      integer , intent(in) :: org(25,0:10)
      integer , intent(in) :: low(25,0:10)
      logical , intent(in) :: dubbel(25,0:10)
!-----------------------------------------------
