...
!   convention JA1 .LE. JB1, JA2 .LE. JB2.
      ...
      DO JW = 1,NPEEL
         ...
         END IF
      END DO
      !if (JA == 1 .and. JB == 27) then
      !    WRITE (*,*)"JA=",JA,"  JB=",JB, " IDQ =",IDQ, " IDQG=",IDQG
      !    WRITE (*,'(4HNQ1=,200(I3))')NQ1(1:NW)
      !    WRITE (*,'(4HNQ2=,200(I3))')NQ2(1:NW)
      !    WRITE (*,'(6HJLIST=,200(I3))')JLIST(1:NW)
      !endif
      !if (JA == 2 .and. JB == 27) then
      !    WRITE (*,*)"JA=",JA,"  JB=",JB, " IDQ =",IDQ, " IDQG=",IDQG
      !    WRITE (*,'(4HNQ1=,200(I3))')NQ1(1:NW)
      !    WRITE (*,'(4HNQ2=,200(I3))')NQ2(1:NW)
      !    WRITE (*,'(6HJLIST=,200(I3))')JLIST(1:NW)
      !endif
      !if (JA == 3 .and. JB == 27) then
      !    WRITE (*,*)"JA=",JA,"  JB=",JB, " IDQ =",IDQ, " IDQG=",IDQG
      !    WRITE (*,'(4HNQ1=,200(I3))')NQ1(1:NW)
      !    WRITE (*,'(4HNQ2=,200(I3))')NQ2(1:NW)
      !    WRITE (*,'(6HJLIST=,200(I3))')JLIST(1:NW)
...
!         3.0 Diagnostic print - NW .LT. 1
          WRITE (*,300)
          WRITE (*,*)"Error"," JA,JB=",JA,JB, " IDQ =",IDQ, " IDQG =",IDQG
          WRITE (*,'(4HNQ1=,200(I3))')NQ1(1:NW)
          WRITE (*,'(4HNQ2=,200(I3))')NQ2(1:NW)
          WRITE (*,'(6HJLIST=,200(I3))')JLIST(1:NW)
          STOP
