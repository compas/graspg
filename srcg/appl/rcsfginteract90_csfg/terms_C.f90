...
!      INTEGER, DIMENSION(357) :: NTAB
      INTEGER, DIMENSION(81) :: ITAB
      INTEGER, DIMENSION(82) :: JTAB
      INTEGER, DIMENSION(509) :: NTAB
      INTEGER :: NROWS
      INTEGER, PRIVATE :: i
      DATA NROWS/ 39/
!
...
! CYC:
! Modifications for orbitals up to 12+
! 
!
!   m, n-   (j = 19/2); 9+, 10-
!
!   First two rows only
!
      DATA (ITAB(I),I=47,48)/ 1,10/
      DATA (JTAB(I),I=47,49)/ 357, 360, 391/
      DATA (NTAB(I),I=358,390)/ 1, 0, 20, 0, 0, 1, 2, 0, 5, 2, 0, 9, 2, 0, 13, &
         2, 0, 17, 2, 0, 21, 2, 0, 25, 2, 0, 29, 2, 0, 33, 2, 0, 37/
...
!   First two rows only
!
      DATA (ITAB(I),I=57,58)/ 1,11/
      DATA (JTAB(I),I=57,59)/ 390, 393, 427/
      DATA (NTAB(I),I=391,426)/ 1, 0, 22, 0, 0, 1, 2, 0, 5, 2, 0, 9, 2, 0, 13, &
         2, 0, 17, 2, 0, 21, 2, 0, 25, 2, 0, 29, 2, 0, 33, 2, 0, 37, 2, 0, 41/
...
!   First two rows only
!
      DATA (ITAB(I),I=68,69)/ 1,12/
      DATA (JTAB(I),I=68,70)/ 427, 430, 467/
      DATA (NTAB(I),I=428,466)/ 1, 0, 22, 0, 0, 1, 2, 0, 5, 2, 0, 9, 2, 0, 13, &
         2, 0, 17, 2, 0, 21, 2, 0, 25, 2, 0, 29, 2, 0, 33, 2, 0, 37, 2, 0, 41, &
         2, 0, 45/
...
!   First two rows only
!
      DATA (ITAB(I),I=80,81)/ 1,13/
      DATA (JTAB(I),I=80,82)/ 466, 469, 509/
      DATA (NTAB(I),I=467,508)/ 1, 0, 22, 0, 0, 1, 2, 0, 5, 2, 0, 9, 2, 0, 13, &
         2, 0, 17, 2, 0, 21, 2, 0, 25, 2, 0, 29, 2, 0, 33, 2, 0, 37, 2, 0, 41, &
         2, 0, 45, 2, 0, 49/
