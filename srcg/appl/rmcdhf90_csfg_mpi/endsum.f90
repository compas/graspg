...
!                                  JCUPA(NNNW*NCF)                     *
!                                                                      *
!   Output the information of da,xa,ya by Chongyang Chen               *
!                                                                      *
!***********************************************************************
...
!
!      WRITE (24,'(A)')"================================================"
!      WRITE (24,'(A)')"  Information of nd, nx, ny, two-electronV   "
!      WRITE (24,'(A)')"================================================"
!      DO I = 1, NW
!         WRITE (24,305) NP(I),NH(I),NDCOFOPT(I), &
!                        NXCOFOPT(I), NYCOFOPT(I),NCOUNTV
!      END DO
...
!
  ...
  305 FORMAT (1X,1I2,1A2,1X,3I10,I15)
      RETURN
!
