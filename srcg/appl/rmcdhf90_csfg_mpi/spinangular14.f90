!***********************************************************************
!                                                                      *
      SUBROUTINE SPINANGULAR14 (JASAV, JBSAV, IUNITF, NPOS, JCSFASAV, JCSFBSAV)
!                                                                      *
...
!                                                                      *
!   Modify for Spin-Angular integration: (Normal CSF and TYPE 4 CSFG)  *
!              <CSF         | H_DC | [core] (n-1)k nk>                 *
!   (n-1)k, nk are symmetry-ordered (by kappa).                        *
...
!
! There is no one-body contributions between TYPE 1 and 4 CSFGs
! 
      IA = 0
      IB = 0
!
...
! Determine the position of the symmetry-ordered orbitals
        ...
        IF (NSYMCR .EQ. 0) THEN
          ...
          STOP 'Warning!!! NSYMCR ERROR ***1*** 14'
...
! determied by IPSym(1), IPSym(2)
        ...
        ELSEIF (NSYMCR .EQ. 3) THEN
          WRITE(*,'(a3, i7, 2x, a3, i7, 2x, a5, 5i3)')              &
               'IC=', JASAV, 'IR=', JBSAV, 'LABV=', LABV(1:5)
          STOP 'Warning!!! NSYMCR ERROR ***3*** 14'

        ELSEIF (NSYMCR .EQ. 4) THEN
          WRITE(*,'(a3, i7, 2x, a3, i7, 2x, a5, 5i3)')              &
               'IC=', JASAV, 'IR=', JBSAV, 'LABV=', LABV(1:5)
          STOP 'Warning!!! NSYMCR ERROR ***4*** 14'
        ENDIF
    2 CONTINUE
