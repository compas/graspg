...
!
!CYC      CALL SETCSH (21, 'rcsfg.inp', NCORE)
      CALL SETCSH_CSFG (21, 'rcsfg.inp', NCORE)
!
...
!
      WRITE (ISTDE, *) 'RWFNESTIMATE_CSFG: Execution complete.'
!
      STOP
      END PROGRAM ERWF
