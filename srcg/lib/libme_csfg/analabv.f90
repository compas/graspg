...
!                                                                      *
! Determine the positions of symbolic-orbitals within LABV             *
!                                                                      *
...
!
      ...
      DO I = 1, 4 
         IF (LABV(I) .GT. NORBGEN) THEN
            ...
            ! Symbolic orbitals of column basis: IC-CSF
               NSYMCOL = NSYMCOL + 1 
            ELSE
            ! Two-eletron electronic interaction 
            ! Symbolic orbitals of row    basis: IR-CSF
               NSYMROW = NSYMROW + 1
            ENDIF
            IPSYM(NSYMCR) = I
         ENDIF
...
!     :          IC, IR, IV, 
!     :          "  The symbolic-Orb doesn't located at position 2 ...."
