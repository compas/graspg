...
!          NORBGEN = 81
!      END SELECT    
!      if (nonsymb.ne.1.and.nonsymb.ne.4.and.nonsymb.ne.9.and.        &
!         nonsymb.ne.16.and.nonsymb.ne.25.and.nonsymb.ne.36.and.      &
!         nonsymb.ne.49.and.nonsymb.ne.64.and.nonsymb.ne.81) then
!         write(*,*)'Error, Stop in findtype.f...'
!         stop 'Abnormal Exit...'
!      endif
      !NMAX=int(sqrt(nonsymb))
      NMAX=nmaxgen
      NORBGEN=nonsymb
...
! CSFs spanned by the symbolic CSFs      
      ...
      DO K = 1,NCFSMALL
        !J = MAP(K)
        ! Smallest list is used, everyone should be counted.
        J = K
