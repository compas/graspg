...
!-----------------------------------------------------------------------
! CYC: There are some bugs for the followings, maybe some values exceeds
! the i4-limitation in case of large-scale calculation.
...
!  later with EAV.
!-----------------------------------------------------------------------
      !if (myid.eq.0) write(*,*)"Call MPI_Allreduce NELMNT_a ..."
...
!cjb  see comments in maneig.f90
  ...
  306 FORMAT('Transverse two-e radial integrals: '/,6I10)
!cjb 1I8 -> 1I16
