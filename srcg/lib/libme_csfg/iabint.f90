!***********************************************************************
!                                                                      *
      SUBROUTINE IABINT (IA0,IB0,TEGRAL)
!                                                                      *
...
!-----------------------------------------------
      INTEGER, INTENT(INOUT) :: ia0, ib0
      REAL(DOUBLE), INTENT(out) :: tegral
!-----------------------------------------------
!   L o c a l   V a r i a b l e s
!-----------------------------------------------
      LOGICAL ::  FOUND
      INTEGER ::  i, index, loc, ju, jl, jm, key, newsiz, iswap, IA, IB
!-----------------------------------------------
!
...
!
! CYC: There is slight differences between off-interaction using
! RINTI(IA,IB,0) and RINTI(IB,IA,0)
! CYC:      TEGRAL = RINTI (IA,IB,0)
            TEGRAL = RINTI (IB,IA,0)
!
