...
!                                                                      *
!   Modified for CSFG version                                          *
!                                                                      *
!   Chongyang Chen       Fudan University                 4 Jan 2021   *
!***********************************************************************
...
!-----------------------------------------------
      ...
      USE memory_man
      USE mpi_C,           ONLY: ierr, MPI_COMM_WORLD
!-----------------------------------------------
...
!-----------------------------------------------
      INTEGER, INTENT(IN) :: nmax, ncf, niv, imcdf,  myid, nprocs
