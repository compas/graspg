!***********************************************************************
!                                                                      *
      SUBROUTINE MATRIXBLOCK15(ICSAV,IRSAV,NCOEC,INCOR,NCTEC,INC2,     &
                 NMCBP,NCORE,ELSTO)
!                                                                      *
!   This subroutine calls onescalar and computes one electron          *
!   matrix elements when IC and IR are of type 1 and 5                 *
!                                                                      *
...
! contributions for type 1 - 2, 3, 4, 5 matrix elements.
            ...
            ELSEIF (NSYMCR .EQ. 2) THEN
              IF (NSYMCOL.NE.1 .OR. NSYMROW.NE.1) THEN
                ...
                STOP 'Unexpected NSYMCOL.NE.1 .OR. NSYMROW.NE.1 in B15 '
              ENDIF
              N = 0 ! Column index
              DO I = 1, NORBCOL 
                LABVI = NTYPE(3, IC) + I - 1
