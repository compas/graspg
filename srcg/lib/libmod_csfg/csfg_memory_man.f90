MODULE csfg_memory_man
! some specific subroutines are added by Chongyang Chen, Dec. 2022
   USE vast_kind_param
   INTERFACE alloc
      MODULE PROCEDURE alloc_0i, alloc_1i, alloc_2i, alloc_3i,     &
                                 alloc_1iL, alloc_1iiL,            &
                       alloc_1r, alloc_2r, alloc_2s,               &
                       alloc_1rL,                                  &
   ...
   INTERFACE ralloc
      MODULE PROCEDURE ralloc_0i, ralloc_1i, ralloc_2i, ralloc_3i, &
                       ralloc_1r, ralloc_2r, ralloc_1iL, ralloc_1rl, &
                       ralloc_0b, ralloc_1b, ralloc_2b, ralloc_3b, &
                       ralloc_1c, ralloc_1i1l, ralloc_2s
...
!    write(777,*) "1i n, var, sub",n, var,"  ", sub
   ...
   SUBROUTINE alloc_1l(p, n, var, sub)
     IMPLICIT NONE
...
!    write(777,*) "2i n1, n2, var, sub",n1, n2, var,"  ", sub
   ...
   SUBROUTINE alloc_2s(p, n1, n2, var, sub)
     IMPLICIT NONE
     INTEGER(SHORT), POINTER, DIMENSION(:,:) :: p
     INTEGER, INTENT(IN) :: n1, n2
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
     INTEGER :: error
...
!    write(777,*) "3i n1, n2, n3, var, sub",n1, n2, n3, var,"  ", sub
   ...
   SUBROUTINE alloc_1iL(p, n, var, sub)
     IMPLICIT NONE
     INTEGER(LONG), POINTER, DIMENSION(:) :: p
     INTEGER, INTENT(IN) :: n
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
     INTEGER :: error
...
!    write(777,*) "1iL n, var, sub",n, var,"  ", sub
   ...
   SUBROUTINE alloc_1iiL(p, n, var, sub)
     IMPLICIT NONE
     INTEGER, POINTER, DIMENSION(:) :: p
...
!    write(777,*) "3b n1, n2, n3, var, sub",n1, n2, n3, var, "  ", sub
   ...
   SUBROUTINE alloc_3bL(p, n1, n2, n3, var, sub)
     IMPLICIT NONE
     INTEGER(BYTE), POINTER, DIMENSION(:,:,:) :: p
     INTEGER, INTENT(IN) :: n1, n2
     INTEGER(LONG), INTENT(IN) :: n3
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
     INTEGER :: error
...
!    write(777,*) "dalloc_1i var, sub",var, "  ", sub
   ...
   SUBROUTINE dalloc_1l(p, var, sub)
     IMPLICIT NONE
     LOGICAL, POINTER, DIMENSION(:) :: p
     CHARACTER(LEN=*) :: var, sub
!    write(777,*) "dalloc_1i var, sub",var, "  ", sub
...
!    write(777,*) "dalloc_2i var, sub",var, "  ", sub
   ...
   SUBROUTINE dalloc_2s(p, var, sub)
     IMPLICIT NONE
     INTEGER(SHORT), POINTER, DIMENSION(:,:) :: p
     CHARACTER(LEN=*) :: var, sub
!    write(777,*) "dalloc_2i var, sub",var, "  ", sub
...
!     write(777,*) "dalloc_3i var, sub",var, "  ", sub
   ...
   SUBROUTINE dalloc_1iL(p, var, sub)
     IMPLICIT NONE
     INTEGER(LONG), POINTER, DIMENSION(:) :: p
     CHARACTER(LEN=*) :: var, sub
!    write(777,*) "dalloc_1i var, sub",var, "  ", sub
...
!    write(777,*) "ralloc_1i n, var, sub",n, var, "  ", sub
   ...
   SUBROUTINE ralloc_1i1l(p, n, var, sub)
     IMPLICIT NONE
     INTEGER, POINTER, DIMENSION(:) :: p, pnew
     INTEGER(LONG), INTENT(IN) :: n
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
...
!    write(777,*) "ralloc_1i n, var, sub",n, var, "  ", sub
     ...
     ELSE
        ...
        p => pnew
     END IF
   END SUBROUTINE ralloc_1i1l


   SUBROUTINE ralloc_1iL(p, n, var, sub)
     IMPLICIT NONE
     INTEGER(LONG), POINTER, DIMENSION(:) :: p, pnew
     INTEGER, INTENT(IN) :: n
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
     INTEGER :: error, nold
!    write(777,*) "ralloc_1i n, var, sub",n, var, "  ", sub
...
!    write(777,*) "ralloc_2i n1, n2, var, sub",n1, n2, var, "  ", sub
     ...
     ELSE
        ...
        IF (error /= 0) then
          Write(6,'(T10,A,A,A,A)') 'Unable to DEallocate ',trim(var), &
                        ' in subroutine ', trim(sub)
          Write(6, '(T10,A,I15,I15)') 'Number of elements requested: ',n1,n2
        STOP
        END IF
   ...
   SUBROUTINE ralloc_2s(p, n1, n2, var, sub)
     IMPLICIT NONE
     INTEGER(SHORT), POINTER, DIMENSION(:,:) :: p, pnew
     INTEGER, INTENT(IN) :: n1, n2
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
     INTEGER :: error, n1_old, n2_old
...
!    write(777,*) "ralloc_1r n, var, sub",n, var, "  ", sub
   ...
   SUBROUTINE ralloc_1rL(p, n, var, sub)
     IMPLICIT NONE
     real(double), POINTER, DIMENSION(:) :: p, pnew
     INTEGER(LONG), INTENT(IN) :: n
     CHARACTER(LEN=*), INTENT(IN) :: var, sub
