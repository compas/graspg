...
!
! CYC: 2022/12/02
      NQ1(1:NW) = IQA(1:NW, JA)
      NQ2(1:NW) = IQA(1:NW, JB)
      !JJQ1(1:3, 1:NW) = JQSA(1:NW, 1:3, JA)
      !JJQ2(1:3, 1:NW) = JQSA(1:NW, 1:3, JB)
      DO J = 1, NW
      !   NQ1(J) = IQ(J,JA)
      !   NQ2(J) = IQ(J,JB)
         DO K = 1, 3
