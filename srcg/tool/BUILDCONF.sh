...
# Generate ${MAKEFILE}
BINARIES_FLAT="$(for p in $PROGRAMS; do echo -n " \${GRASPG}/bin/$p"; done)"
...
for program in ${PROGRAMS}; do
	...
	target_link_libraries_Fortran(${program} PRIVATE )
